...
%%END LATEX_FONTENC
  ...
  \fancypagestyle{fancyplain}{
    ...
    \fancyfoot[LO, RE]{\bfseries\scriptsize $generatedby WolfNet Computing using Doxygen $doxygenversion}
  }
...
%%END PROJECT_NUMBER
  \vspace*{1cm}
  {\large $generatedby WolfNet Computing using Doxygen $doxygenversion}\\
