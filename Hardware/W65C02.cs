...
namespace Hardware
{
    ...
    {
        #region Fields
        private readonly ILogger _logger = LogManager.GetLogger("Processor");
		...
		private void ExecuteOpCode()
        {
            ...
            switch (CurrentOpCode)
            {
                ...
                case 0xA9:
                    {
                        Accumulator = MemoryMap.Read(GetAddressByAddressingMode(AddressingMode.Immediate));
                ...
                case 0xA5:
                    {
                        Accumulator = MemoryMap.Read(GetAddressByAddressingMode(AddressingMode.ZeroPage));
                        SetZeroFlag(Accumulator);
                        SetNegativeFlag(Accumulator);
                        break;
                    }
                ...
                case 0xB5:
                    {
                        Accumulator = MemoryMap.Read(GetAddressByAddressingMode(AddressingMode.ZeroPageX));
                        SetZeroFlag(Accumulator);
                        SetNegativeFlag(Accumulator);
                        break;
                    }
                ...
                case 0xAD:
                    {
                        Accumulator = MemoryMap.Read(GetAddressByAddressingMode(AddressingMode.Absolute));
                        SetZeroFlag(Accumulator);
                        SetNegativeFlag(Accumulator);
                        break;
                    }
                ...
                case 0xBD:
                    {
                        Accumulator = MemoryMap.Read(GetAddressByAddressingMode(AddressingMode.AbsoluteX));
                        SetZeroFlag(Accumulator);
                        SetNegativeFlag(Accumulator);
                        break;
                    }
                ...
                case 0xB9:
                    {
                        Accumulator = MemoryMap.Read(GetAddressByAddressingMode(AddressingMode.AbsoluteY));
                        SetZeroFlag(Accumulator);
                        SetNegativeFlag(Accumulator);
                        break;
                    }
                ...
                case 0xA1:
                    {
                        Accumulator = MemoryMap.Read(GetAddressByAddressingMode(AddressingMode.IndirectX));
                        SetZeroFlag(Accumulator);
                        SetNegativeFlag(Accumulator);
                        break;
                    }
                ...
                case 0xB1:
                    {
                        Accumulator = MemoryMap.Read(GetAddressByAddressingMode(AddressingMode.IndirectY));
                        SetZeroFlag(Accumulator);
                        SetNegativeFlag(Accumulator);
                        break;
                    }
                ...
                case 0xA2:
                    {
                        XRegister = MemoryMap.Read(GetAddressByAddressingMode(AddressingMode.Immediate));
                ...
                case 0xA6:
                    {
                        XRegister = MemoryMap.Read(GetAddressByAddressingMode(AddressingMode.ZeroPage));
                        SetZeroFlag(XRegister);
                        SetNegativeFlag(XRegister);
                        break;
                    }
                ...
                case 0xB6:
                    {
                        XRegister = MemoryMap.Read(GetAddressByAddressingMode(AddressingMode.ZeroPageY));
                        SetZeroFlag(XRegister);
                        SetNegativeFlag(XRegister);
                        break;
                    }
                ...
                case 0xAE:
                    {
                        XRegister = MemoryMap.Read(GetAddressByAddressingMode(AddressingMode.Absolute));
                        SetZeroFlag(XRegister);
                        SetNegativeFlag(XRegister);
                        break;
                    }
                ...
                case 0xBE:
                    {
                        XRegister = MemoryMap.Read(GetAddressByAddressingMode(AddressingMode.AbsoluteY));
                        SetZeroFlag(XRegister);
                        SetNegativeFlag(XRegister);
                        break;
                    }
                ...
                case 0xA0:
                    {
                        YRegister = MemoryMap.Read(GetAddressByAddressingMode(AddressingMode.Immediate));
                ...
                case 0xA4:
                    {
                        YRegister = MemoryMap.Read(GetAddressByAddressingMode(AddressingMode.ZeroPage));
                        SetZeroFlag(YRegister);
                        SetNegativeFlag(YRegister);
                        break;
                    }
                ...
                case 0xB4:
                    {
                        YRegister = MemoryMap.Read(GetAddressByAddressingMode(AddressingMode.ZeroPageX));
                        SetZeroFlag(YRegister);
                        SetNegativeFlag(YRegister);
                        break;
                    }
                ...
                case 0xAC:
                    {
                        YRegister = MemoryMap.Read(GetAddressByAddressingMode(AddressingMode.Absolute));
                        SetZeroFlag(YRegister);
                        SetNegativeFlag(YRegister);
                        break;
                    }
                ...
                case 0xBC:
                    {
                        YRegister = MemoryMap.Read(GetAddressByAddressingMode(AddressingMode.AbsoluteX));
                        SetZeroFlag(YRegister);
                        SetNegativeFlag(YRegister);
                        break;
                    }
                ...
                case 0x48:
                    {
                        MemoryMap.Read(ProgramCounter + 1);
                ...
                case 0x85:
                    {
                        MemoryMap.Write(GetAddressByAddressingMode(AddressingMode.ZeroPage), (byte)Accumulator);
                        break;
                    }
                //STA Store Accumulator In Memory, Zero Page X, 2 Bytes, 4 Cycles
                case 0x95:
                    {
                        MemoryMap.Write(GetAddressByAddressingMode(AddressingMode.ZeroPageX), (byte)Accumulator);
                        break;
                    }
                //STA Store Accumulator In Memory, Absolute, 3 Bytes, 4 Cycles
                case 0x8D:
                    {
                        MemoryMap.Write(GetAddressByAddressingMode(AddressingMode.Absolute), (byte)Accumulator);
                        break;
                    }
                //STA Store Accumulator In Memory, Absolute X, 3 Bytes, 5 Cycles
                case 0x9D:
                    {
                        MemoryMap.Write(GetAddressByAddressingMode(AddressingMode.AbsoluteX), (byte)Accumulator);
                        IncrementCycleCount();
                        break;
                    }
                ...
                case 0x99:
                    {
                        MemoryMap.Write(GetAddressByAddressingMode(AddressingMode.AbsoluteY), (byte)Accumulator);
                        IncrementCycleCount();
                        break;
                    }
                ...
                case 0x81:
                    {
                        MemoryMap.Write(GetAddressByAddressingMode(AddressingMode.IndirectX), (byte)Accumulator);
                        break;
                    }
                //STA Store Accumulator In Memory, Indirect Indexed, 2 Bytes, 6 Cycles
                case 0x91:
                    {
                        MemoryMap.Write(GetAddressByAddressingMode(AddressingMode.IndirectY), (byte)Accumulator);
                        IncrementCycleCount();
                        break;
                    }
                ...
                case 0x86:
                    {
                        MemoryMap.Write(GetAddressByAddressingMode(AddressingMode.ZeroPage), (byte)XRegister);
                        break;
                    }
                //STX Store Index X, Zero Page Y, 2 Bytes, 4 Cycles
                case 0x96:
                    {
                        MemoryMap.Write(GetAddressByAddressingMode(AddressingMode.ZeroPageY), (byte)XRegister);
                        break;
                    }
                //STX Store Index X, Absolute, 3 Bytes, 4 Cycles
                case 0x8E:
                    {
                        MemoryMap.Write(GetAddressByAddressingMode(AddressingMode.Absolute), (byte)XRegister);
                        break;
                    }
                //STY Store Index Y, Zero Page, 2 Bytes, 3 Cycles
                case 0x84:
                    {
                        MemoryMap.Write(GetAddressByAddressingMode(AddressingMode.ZeroPage), (byte)YRegister);
                        break;
                    }
                //STY Store Index Y, Zero Page X, 2 Bytes, 4 Cycles
                case 0x94:
                    {
                        MemoryMap.Write(GetAddressByAddressingMode(AddressingMode.ZeroPageX), (byte)YRegister);
                        break;
                    }
                //STY Store Index Y, Absolute, 2 Bytes, 4 Cycles
                case 0x8C:
                    {
                        MemoryMap.Write(GetAddressByAddressingMode(AddressingMode.Absolute), (byte)YRegister);
                        break;
                    }
                #endregion
        ...
        protected int GetAddressByAddressingMode(AddressingMode addressingMode)
        {
            ...
            switch (addressingMode)
            {
                case (AddressingMode.Absolute):
                    {
                        return (MemoryMap.Read(ProgramCounter++) | (MemoryMap.Read(ProgramCounter++) << 8));
                    }
                case AddressingMode.AbsoluteX:
                    {
                        //Get the low half of the address
                        address = MemoryMap.Read(ProgramCounter++);

                        //Get the high byte
                        highByte = MemoryMap.Read(ProgramCounter++);
                        ...
                        if (address + XRegister > 0xFF)
                        {
                            switch (CurrentOpCode)
                            {
                                ...
                                case 0x9D:
                                    {
                                        //This is a MemoryMap.Read Fetch Write Operation, so we don't make the extra read.
                                        return ((highByte << 8 | address) + XRegister) & 0xFFFF;
                                    }
                                default:
                                    {
                                        MemoryMap.Read((((highByte << 8 | address) + XRegister) - 0xFF) & 0xFFFF);
                                        break;
                                    }
                            }
                        }
                ...
                case AddressingMode.AbsoluteY:
                    {
                        ...
                        {
                            MemoryMap.Read((((highByte << 8 | address) + YRegister) - 0xFF) & 0xFFFF);
                        }
                ...
                case AddressingMode.IndirectX:
                    {
                        ...
                        address = MemoryMap.Read(ProgramCounter++);
                        MemoryMap.Read(address);

                        address += XRegister;

                        //Now get the final Address. The is not a zero page address either.
                        var finalAddress = MemoryMap.Read((address & 0xFF)) | (MemoryMap.Read((address + 1) & 0xFF) << 8);
                        return finalAddress;
                    }
                case AddressingMode.IndirectY:
                    {
                        ...
                        var finalAddress = MemoryMap.Read(address) + (MemoryMap.Read((address + 1) & 0xFF) << 8);

                        if ((finalAddress & 0xFF) + YRegister > 0xFF && CurrentOpCode != 0x91)
                        {
                            MemoryMap.Read((finalAddress + YRegister - 0xFF) & 0xFFFF);
                        }
        ...
        protected void AddWithCarryOperation(AddressingMode addressingMode)
        {
            ...
            var memoryValue = MemoryMap.Read(GetAddressByAddressingMode(addressingMode));
        ...
        {
            Accumulator = MemoryMap.Read(GetAddressByAddressingMode(addressingMode)) & Accumulator;
        ...
        public void AslOperation(AddressingMode addressingMode)
        {
            ...
            else
            {
                ...
                value = MemoryMap.Read(memoryAddress);
            }

            //Dummy Write
            if (addressingMode != AddressingMode.Accumulator)
            {
                MemoryMap.Write(memoryAddress, (byte)value);
            }
        ...
        {
            var value = MemoryMap.Read(GetAddressByAddressingMode(AddressingMode.Relative));
        ...
        private void ChangeMemoryByOne(AddressingMode addressingMode, bool decrement)
        {
            ...
            var memory = MemoryMap.Read(memoryLocation);

            MemoryMap.Write(memoryLocation, memory);
        ...
        {
            Accumulator = Accumulator ^ MemoryMap.Read(GetAddressByAddressingMode(addressingMode));
        ...
        /// </summary>
        /// <param name="addressingMode">The addressing mode to use</param>
        protected void SubtractWithBorrowOperation(AddressingMode addressingMode)
        {
            var memoryValue = MemoryMap.Read(GetAddressByAddressingMode(addressingMode));
            var newValue = DecimalFlag ? int.Parse(Accumulator.ToString("x")) - int.Parse(memoryValue.ToString("x")) - (CarryFlag ? 0 : 1) : Accumulator - memoryValue - (CarryFlag ? 0 : 1);
        ...
        private void BreakOperation(bool isBrk, int vector)
        {
            ...
            ProgramCounter = (MemoryMap.Read(vector + 1) << 8) | MemoryMap.Read(vector);
